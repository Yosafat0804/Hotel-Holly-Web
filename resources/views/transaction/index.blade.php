                                ...
                                <tr class="text-center table-primary">
                                    ...
                                    <td>
                                        ...
                                        @elseif ($item->status == 'verified')
                                            ...
                                            @if (is_null($item->actual_check_out))
                                                <form action="{{ route('transaction.earlyCheckout', $item->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('get')
                                                    <button type="submit" class="btn btn-warning btn-sm">Checkout Now</button>
                                                </form>
                                            @endif
