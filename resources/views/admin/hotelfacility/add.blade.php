    ...
    <div class="card-body" style="padding:2rem;">
        <form action="{{ route('hotelfacility.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="detail" class="form-control @error('detail') is-invalid @enderror" id="detail" rows="3" required autocomplete="detail" autofocus style="border-radius:16px; border:1.5px solid #d4af37;">{{ old('detail') }}</textarea>
                @error('detail')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
