...
<div class="card shadow-lg" style="border-radius:24px; border:2px solid #d4af37; background:#fff;">
    <div class="card-header" style="background:#00008b; color:#fff; font-weight:bold; border-radius:22px 22px 0 0; letter-spacing:1px;">
      ...
      <div class="card-tools">
          <a href="{{ route('hotelfacility.create') }}" class="btn btn-sm" style="background:#d4af37; color:#000; font-weight:bold; border-radius:16px; margin-left:12px;">
            ...
            <tbody>
                @foreach ($datas as $dt)
                    <tr class="text-center" style="background:#fffbe6; color:#000;">
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('hotelfacility.edit', $dt->id) }}" class="btn btn-sm btn-warning" style="border-radius:14px; font-weight:bold;">Edit</a>
                                <a href="{{ route('hotelfacility.delete', $dt->id) }}" onclick="return confirm('Yakin?')" class="btn btn-sm btn-danger" style="border-radius:14px; font-weight:bold;">Delete</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
