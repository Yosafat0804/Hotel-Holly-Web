    ...
    <div class="card-body" style="padding:2rem;">
        <form action="{{ route('roomfacility.update', $data->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input id="facility_name" name="facility_name" value="{{$data->facility_name}}" type="text" class="form-control @error('facility_name') is-invalid @enderror" value="{{ old('facility_name') }}" required autocomplete="facility_name" autofocus style="border-radius:16px; border:1.5px solid #d4af37;">
                @error('facility_name')
