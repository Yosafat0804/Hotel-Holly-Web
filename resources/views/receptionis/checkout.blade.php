                ...
                <tbody>
                    @foreach ($datas as $item)
                        <tr class="text-center" style="background:#fffbe6; color:#000;">
                            ...
                            <td>
                                <a data-transaction-id="{{ $item->room_id }}" href="{{route('receptionis.viewCheckoutNote', $item->id)}}" class="btn btn-sm btn-info" style="border-radius:18px; font-weight:bold;">Catatan</a>                                
                                ...
                                @else
                                    <span class="text-success" style="font-weight: bold;">Checked Out</span>
                                @endif
                            </td>
                        </tr>
                    @endforeach
